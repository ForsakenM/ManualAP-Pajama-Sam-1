...
1. You'll first need to download and install the latest version of the Archipelago Launcher, link to which is provided above.
2. Next you'll need to downloaded and install the latest version of the Manual Client. To install, you can either copy the apworld file, then navigate to your `custom_worlds` folder within your `Archipelago` folder and paste the apworld file there...or you can double-click the apworld file and let it install itself!